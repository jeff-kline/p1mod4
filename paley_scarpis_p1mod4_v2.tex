...
there is no input matrix; the finite bands are given entrywise in
...
and Wang.  The family nevertheless resolves no open Hadamard order:
...
\(q\equiv1\pmod4\) is due to Farouk and Wang \cite{FaroukWang2020}; this
note claims no new existence result.  Its contribution is the method of
...
counterpart in \cite{FaroukWang2020}: it locates every order of the
family against the audited tables and shows the family resolves no open
Hadamard order.
